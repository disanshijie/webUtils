// JavaScript Document
var public_hostlist = { 'http://csstools.chinaz.com/common/js/mobile.chinaz.com': 1, 'http://csstools.chinaz.com/common/js/index.chinaz.com': 1, 'http://csstools.chinaz.com/common/js/wapseo.chinaz.com': 1 };
var toolbox_url = "http://csstools.chinaz.com/ajaxsync.aspx";
$(function () {
...
function getLochis() {
    ...
    $("#selecthis").hover(function () {
        ...
        if (public_hostlist[location.host]) {
            ...
            url = "http://csstools.chinaz.com/ajaxsync.aspx?at=qh&val=";
        }
        $.ajax({
            type: "get",
...
function bindClick() {
    $("i.jsclear").click(function () {
        ...
        if (public_hostlist[location.host]) {
            ...
            url = "http://csstools.chinaz.com/ajaxsync.aspx?at=clearqh&val=";
        }
    ...
    $("#jsclearall").click(function () {
        ...
        if (public_hostlist[location.host]) {
            ...
            url = "http://csstools.chinaz.com/ajaxsync.aspx?at=clearqh&val=all";
        }
