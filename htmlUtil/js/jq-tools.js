...
var tools = {
    ...
    openweb: {
        openAttr: function (istest) {
            ...
            if (istest) {
                if (address == "http://" || !address) { $("#errorinfo").text("������URL��").show(); return; }
    ...
    regex: {
        regCommon: {
            chines: "[\\u4e00-\\u9fa5]", //����
            doubleByte: "[^\\x00-\\xff]", //˫�ֽڣ��������ģ�
            nullLine: "\\s", //�հ���
            email: "\\w[-\\w.+]*@([A-Za-z0-9][-A-Za-z0-9]+\\.)+[A-Za-z]{2,14}", //����
            url: "^((https|http|ftp|rtsp|mms)?:\\/\\/)[^\\s]+", //��ַ��ֻ��֤�Ƿ����ĳЩǰ׺��
            phone: "0?(13|14|15|17|18|19)[0-9]{9}", //�����ֻ�
            tel: "[0-9-()����]{7,18}", //���ڵ绰
            nFloat: "-([1-9]\\d*.\\d*|0.\\d*[1-9]\\d*)", //��������
            interger: "-?[1-9]\\d*", //����
            pFloat: "[1-9]\\d*.\\d*|0.\\d*[1-9]\\d*", //�������� [1-9]\d*\.\d+|0\.\d*[1-9]\d*
            qq: "[1-9]([0-9]{5,11})", //QQ��
            postal: "\\d{6}", //������������
    ...
    o = f.options;
        ...
        init: function () {
            ...
            $("#inputText,#searchText").bind("keyup keydown blur", function () {
                ...
                $("#result p").html("ƥ�䵽 <strong>" + arr.length + "</strong> �������");
            });
        },
        languageCode: {
        ...
        qrcode: {
            ...
            init: function () {
                ...
                jQuery("#txtarea").focus(function () {
                    ...
                    $(this).removeClass("col-gray");
                    if (v == '200�ַ�����') jQuery(this).val('')
                }).blur(function () {
                    var v = jQuery(this).val();
                    if (v == '') {
                        jQuery(this).val('200�ַ�����');
    ...
    other: {
        ...
        httptest: function () {
            ...
            pramsHtml += '<div class="Porname"><input type="text" class="TitInput _WrapHid w240" name="paramsname" value="{0}" /><b class="search-hint CentHid mt5" style="display:{2}">������</b></div>';
            pramsHtml += '<div class="Porname ml10"><input type="text" class="TitInput _WrapHid w360" name="paramsval" value="{1}" /><b class="search-hint CentHid mt5" style="display:{2}">ֵ</b></div>';
            pramsHtml += '<div class="fl pl10"><input type="button" value="ɾ��" class="TitInBtn w70 removeparams" /></div></div>';
    ...
    encryptDecode: {
        ...
        unixtime: {
            ...
            unix2human: function () {
                ...
                if (dateObj.format('yyyy') == "NaN") { /*alert("ʱ�����ʽ����ȷ");*/return; }
            ...
            human2unix: function () {
                ...
                var year = form.year.value; if (!year) { /*alert("ʱ���ʽ����ȷ");*/return; }
                ...
                if (humanDate.format('yyyy') == "NaN") { /*alert("ʱ���ʽ����ȷ");*/return; }
        ...
        htmlCodeCov: {
            ...
            htmlCov: function () {
                ...
                switch (type) {
                    ...
                    default: getid("result").value = 'ת������'; break;
                }
                if (jQuery("#result").val()) $("#result").siblings().hide();
            },
            init: function (path) {
    ...
    jsonTool: {
                ...
                _genTypeByProp: function (name, val) {
                    try {
                        if (typeof val == "string") {
                            var regdt = /^(\d{4})(-|\/|��)(\d{2})(-|\/|��)(\d{2})(��)?(\s((\d{1,2}):)?((\d{1,2}):)?(\d{1,2})?)?$/
        ...
        jsontoxml: function () {
            $("#2json").click(function () {
                ...
                xmlText = xmlText.replace(/&gt;/g, ">").replace(/&lt;/g, "<").replace(/&quot;/g, "\""); //HTMLת��
